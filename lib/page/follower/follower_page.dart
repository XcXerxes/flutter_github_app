 ...
 * @LastEditors: leo
 * @LastEditTime: 2020-06-05 15:43:02
 */
...
class FollowerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: Provider.of<ProfileProvider>(context, listen: false).getFollowerList(userName),
                ...
                return EasyRefresh.custom(
                  ...
                  onRefresh: () async {
                    ...
                    return Provider.of<ProfileProvider>(context, listen: false)
                        .getFollowerList(userName, page: page);
                  },
                  onLoad: () async {
                    page++;
                    return Provider.of<ProfileProvider>(context, listen: false)
                  ...
                  slivers: <Widget>[
                    SliverList(
                      delegate: SliverChildBuilderDelegate((context, int index) {
                        return FollowerItem(profile.followerList[index]);
                      }, childCount: profile.followerList.length),
                    )
                  ],
                );
              },
